...
public class DatabaseConstant {
    ...
    public static final String FK_USER_SALON = "salon_id";
    ...
    public static final String FK_APPOINTMENT_SALON = "salon_id";
    ...
    public static final String STYLIST_AVATAR = "avatar";
    ...
    public static final String USER_QUERY = "CREATE TABLE IF NOT EXISTS " + TABLE_USER + " (" +
            ...
            USER_AVATAR + " BLOB," +
            FK_USER_SALON + " INTEGER," +
            "UNIQUE(" + USER_USERNAME + "," + USER_EMAIL + "," + USER_PHONE + ")," +
            "CONSTRAINT fk_user_salon FOREIGN KEY (" + FK_USER_SALON + ") " +
    ...
    public static final String APPOINTMENT_QUERY = "CREATE TABLE IF NOT EXISTS " + TABLE_APPOINTMENT + " (" +
            ...
            FK_APPOINTMENT_STYLIST + " INTEGER NOT NULL," +
            FK_APPOINTMENT_VOUCHER + " INTEGER," +
            FK_APPOINTMENT_SALON + " INTEGER NOT NULL," +
            ...
            "CONSTRAINT fk_appointment_salon FOREIGN KEY (" + FK_APPOINTMENT_SALON + ") " +
            "REFERENCES " + TABLE_SALON + "(" + SALON_ID + ") ON UPDATE CASCADE ON DELETE CASCADE" +
            ")";
    ...
    public static final String RATING_QUERY = "CREATE TABLE IF NOT EXISTS " + TABLE_RATING + " (" +
            ...
            FK_RATING_CUSTOMER + " INTEGER NOT NULL," +
            FK_RATING_STYLIST + " INTEGER NOT NULL," +
    ...
    public static final String USER_VOUCHER_QUERY = "CREATE TABLE IF NOT EXISTS " + TABLE_USER_VOUCHER + " (" +
            UV_USER + " INTEGER NOT NULL," +
            UV_VOUCHER + " INTEGER NOT NULL," +
